...
public class scp_Player_Movement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        //Sets the camera root's position to the same as this gameobject
    ...
    {
        return Physics.CheckSphere(transform.position, 0.8f, groundLayer);
    }
}
